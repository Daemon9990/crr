...
# Encrypted Watermark
__encrypted_watermark__ = "cd79228d1b9a262147275a2b6c9bddacb9a42351d8b396993584bd8b96fdb5c4"

# Tamper Check
import hashlib
import os
current_file = os.path.abspath(__file__)
if hashlib.sha256("Protected by Abhinai, CONTACT IN TG :@CLUTCH008 ".encode()).hexdigest() != __encrypted_watermark__:
    print("Watermark tampered! Destroying the script.")
    with open(current_file, 'w') as f:
        f.write("# This script has been tampered with and is now destroyed.")
    exit(1)
...
# Protected by Abhinai

__watermark__ = 'Protected by ABHI '  # Do not remove
